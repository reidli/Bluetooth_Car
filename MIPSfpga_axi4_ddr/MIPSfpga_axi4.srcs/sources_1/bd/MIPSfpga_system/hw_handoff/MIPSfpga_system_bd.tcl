...
proc create_root_design { parentCell } {
  ...
  set sencer [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 sencer ]
  ...
  set Pwm0A [ create_bd_port -dir O Pwm0A ]
  set Pwm0B [ create_bd_port -dir O Pwm0B ]
  set Pwm2A [ create_bd_port -dir O Pwm2A ]
  set Pwm2B [ create_bd_port -dir O Pwm2B ]
  set UART_RXD_OUT [ create_bd_port -dir O UART_RXD_OUT ]
  set UART_TXD_IN [ create_bd_port -dir I UART_TXD_IN ]
  set btin [ create_bd_port -dir I btin ]
  set btout [ create_bd_port -dir O btout ]
  set hs_in [ create_bd_port -dir I hs_in ]
  set hs_out [ create_bd_port -dir O hs_out ]
  set sxtrest [ create_bd_port -dir O -from 0 -to 0 sxtrest ]
  set vgain [ create_bd_port -dir I -from 7 -to 0 vgain ]
  set vgaout [ create_bd_port -dir O -from 7 -to 0 vgaout ]
  set vs_in [ create_bd_port -dir I vs_in ]
  set vs_out [ create_bd_port -dir O vs_out ]
  ...
  set_property -dict [ list CONFIG.C_GPO_WIDTH {1} CONFIG.IIC_FREQ_KHZ {20}  ] $axi_iic_0
...
CONFIG.CLKOUT1_JITTER {132.683} CONFIG.CLKOUT1_PHASE_ERROR {87.180} \
CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {50.000} CONFIG.CLKOUT2_DRIVES {BUFG} \
CONFIG.CLKOUT2_JITTER {102.086} CONFIG.CLKOUT2_PHASE_ERROR {87.180} \
CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {200.000} CONFIG.CLKOUT2_USED {true} \
CONFIG.CLKOUT3_DRIVES {BUFG} CONFIG.CLKOUT3_JITTER {155.487} \
CONFIG.CLKOUT3_PHASE_ERROR {87.180} CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {24.000} \
CONFIG.CLKOUT3_USED {true} CONFIG.CLKOUT4_DRIVES {BUFG} \
CONFIG.CLKOUT5_DRIVES {BUFG} CONFIG.CLKOUT6_DRIVES {BUFG} \
CONFIG.CLKOUT7_DRIVES {BUFG} CONFIG.MMCM_CLKFBOUT_MULT_F {12} \
CONFIG.MMCM_CLKOUT0_DIVIDE_F {24} CONFIG.MMCM_CLKOUT1_DIVIDE {6} \
CONFIG.MMCM_CLKOUT2_DIVIDE {50} CONFIG.MMCM_COMPENSATION {ZHOLD} \
...
CONFIG.USE_RESET {false}  ] $clk_wiz_0
  ...
  set_property -dict [ list CONFIG.ALL_PROBE_SAME_MU {true} \
CONFIG.ALL_PROBE_SAME_MU_CNT {2} CONFIG.C_ADV_TRIGGER {true} \
CONFIG.C_DATA_DEPTH {1024} CONFIG.C_ENABLE_ILA_AXI_MON {true} \
CONFIG.C_EN_STRG_QUAL {1} CONFIG.C_INPUT_PIPE_STAGES {0} \
CONFIG.C_MONITOR_TYPE {AXI} CONFIG.C_NUM_OF_PROBES {19} \
CONFIG.C_PROBE0_MU_CNT {2} CONFIG.C_PROBE0_WIDTH {1} \
CONFIG.C_PROBE10_MU_CNT {2} CONFIG.C_PROBE11_MU_CNT {2} \
CONFIG.C_PROBE12_MU_CNT {2} CONFIG.C_PROBE13_MU_CNT {2} \
CONFIG.C_PROBE14_MU_CNT {2} CONFIG.C_PROBE15_MU_CNT {2} \
CONFIG.C_PROBE16_MU_CNT {2} CONFIG.C_PROBE17_MU_CNT {2} \
CONFIG.C_PROBE18_MU_CNT {2} CONFIG.C_PROBE19_MU_CNT {2} \
CONFIG.C_PROBE1_MU_CNT {2} CONFIG.C_PROBE20_MU_CNT {2} \
CONFIG.C_PROBE21_MU_CNT {2} CONFIG.C_PROBE22_MU_CNT {2} \
CONFIG.C_PROBE23_MU_CNT {2} CONFIG.C_PROBE24_MU_CNT {2} \
CONFIG.C_PROBE25_MU_CNT {2} CONFIG.C_PROBE26_MU_CNT {2} \
CONFIG.C_PROBE27_MU_CNT {2} CONFIG.C_PROBE28_MU_CNT {2} \
CONFIG.C_PROBE29_MU_CNT {2} CONFIG.C_PROBE2_MU_CNT {2} \
CONFIG.C_PROBE30_MU_CNT {2} CONFIG.C_PROBE31_MU_CNT {2} \
CONFIG.C_PROBE32_MU_CNT {2} CONFIG.C_PROBE33_MU_CNT {2} \
CONFIG.C_PROBE34_MU_CNT {2} CONFIG.C_PROBE35_MU_CNT {2} \
CONFIG.C_PROBE36_MU_CNT {2} CONFIG.C_PROBE37_MU_CNT {2} \
CONFIG.C_PROBE38_MU_CNT {2} CONFIG.C_PROBE39_MU_CNT {2} \
CONFIG.C_PROBE3_MU_CNT {2} CONFIG.C_PROBE40_MU_CNT {2} \
CONFIG.C_PROBE41_MU_CNT {2} CONFIG.C_PROBE42_MU_CNT {2} \
CONFIG.C_PROBE43_MU_CNT {2} CONFIG.C_PROBE44_MU_CNT {2} \
CONFIG.C_PROBE4_MU_CNT {2} CONFIG.C_PROBE5_MU_CNT {2} \
CONFIG.C_PROBE6_MU_CNT {2} CONFIG.C_PROBE7_MU_CNT {2} \
CONFIG.C_PROBE8_MU_CNT {2} CONFIG.C_PROBE9_MU_CNT {2} \
CONFIG.C_TRIGIN_EN {false} CONFIG.C_TRIGOUT_EN {false} \
 ] $ila_0
  ...
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports sencer] [get_bd_intf_pins axi_iic_0/IIC]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins Motor_driver_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M07_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_iic_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M08_AXI]
connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_interconnect_0/M08_AXI] [get_bd_intf_pins ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net MIPS_MicroAptiv_UP_0_HCLK [get_bd_pins MIPS_MicroAptiv_UP_0/HCLK] [get_bd_pins Motor_driver_0/s00_axi_aclk] [get_bd_pins PWM_w_Int_0/s00_axi_aclk] [get_bd_pins ahblite_axi_bridge_0/s_ahb_hclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins axi_uart16550_1/s_axi_aclk] [get_bd_pins ila_0/clk]
  connect_bd_net -net MIPS_MicroAptiv_UP_0_HRESETn [get_bd_ports sxtrest] [get_bd_pins MIPS_MicroAptiv_UP_0/HRESETn] [get_bd_pins Motor_driver_0/s00_axi_aresetn] [get_bd_pins PWM_w_Int_0/s00_axi_aresetn] [get_bd_pins ahblite_axi_bridge_0/s_ahb_hresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_interconnect_0/M08_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins axi_uart16550_1/s_axi_aresetn] [get_bd_pins mig_7series_0/aresetn]
  connect_bd_net -net Motor_driver_0_Dir_clk [get_bd_ports Dir_clk] [get_bd_pins Motor_driver_0/Dir_clk]
  connect_bd_net -net Motor_driver_0_Dir_enable [get_bd_ports Dir_enable] [get_bd_pins Motor_driver_0/Dir_enable]
  connect_bd_net -net Motor_driver_0_Dir_latch [get_bd_ports Dir_latch] [get_bd_pins Motor_driver_0/Dir_latch]
  connect_bd_net -net Motor_driver_0_Dir_serial [get_bd_ports Dir_serial] [get_bd_pins Motor_driver_0/Dir_serial]
  connect_bd_net -net Motor_driver_0_Pwm0A [get_bd_ports Pwm0A] [get_bd_pins Motor_driver_0/Pwm0A]
  connect_bd_net -net Motor_driver_0_Pwm0B [get_bd_ports Pwm0B] [get_bd_pins Motor_driver_0/Pwm0B]
  connect_bd_net -net Motor_driver_0_Pwm2A [get_bd_ports Pwm2A] [get_bd_pins Motor_driver_0/Pwm2A]
  connect_bd_net -net Motor_driver_0_Pwm2B [get_bd_ports Pwm2B] [get_bd_pins Motor_driver_0/Pwm2B]
  connect_bd_net -net PWM_w_Int_0_Interrupt_out [get_bd_pins PWM_w_Int_0/Interrupt_out] [get_bd_pins xlconcat_1/In4]
  ...
  connect_bd_net -net axi_uart16550_1_ip2intc_irpt [get_bd_pins axi_uart16550_1/ip2intc_irpt] [get_bd_pins xlconcat_1/In3]
  connect_bd_net -net axi_uart16550_1_sout [get_bd_ports btout] [get_bd_pins axi_uart16550_1/sout]
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_ports xclk] [get_bd_pins clk_wiz_0/clk_out3]
  connect_bd_net -net hs_in_1 [get_bd_ports hs_in] [get_bd_ports hs_out]
  ...
  connect_bd_net -net sin_2 [get_bd_ports btin] [get_bd_pins axi_uart16550_1/sin]
  ...
  connect_bd_net -net vgain_1 [get_bd_ports vgain] [get_bd_ports vgaout]
  connect_bd_net -net vs_in_1 [get_bd_ports vs_in] [get_bd_ports vs_out]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x10800000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/ahblite] [get_bd_addr_segs Motor_driver_0/S00_AXI/S00_AXI_reg] SEG_Motor_driver_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x10E00000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/ahblite] [get_bd_addr_segs axi_iic_0/S_AXI/Reg] SEG_axi_iic_0_Reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x10A00000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/ahblite] [get_bd_addr_segs axi_uart16550_1/S_AXI/Reg] SEG_axi_uart16550_1_Reg
